        ...
        <div className="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="max-w-sm mx-auto grid gap-12 md:gap-x-6 lg:gap-x-12 md:grid-cols-3 items-start md:max-w-none">
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div
                aria-hidden="true"
                className="absolute h-px opacity-50 bg-gradient-to-t from-white via-teal-400 to-white dark:from-gray-900 dark:via-teal-400 dark:to-gray-900 hidden md:block"
              ...
              <div className="inline-flex relative justify-center items-center">
                {/* Image inside mockup size: 290 x 624 */}
                <img className="absolute" width="290" height="624" style={{ maxWidth: "84.33%" }} src={Image2.src} alt="App screen 02" />
                {/* Iphone mockup */}
                <img
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="inline-flex relative justify-center items-center">
                {/* Image inside mockup size: 290 x 624 */}
                <img className="absolute" width="290" height="624" style={{ maxWidth: "84.33%" }} src={Image3.src} alt="App screen 02" />
                {/* Iphone mockup */}
                <img
                  className="relative max-w-full mx-auto h-auto pointer-events-none"
                  width="344"
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="inline-flex relative justify-center items-center">
                {/* Image inside mockup size: 290 x 624 */}
                <img className="absolute" width="290" height="624" style={{ maxWidth: "84.33%" }} src={Image4.src} alt="App screen 02" />
                {/* Iphone mockup */}
                <img
                  className="relative max-w-full mx-auto h-auto pointer-events-none"
                  width="344"
